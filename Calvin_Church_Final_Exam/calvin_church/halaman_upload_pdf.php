...
if (isset($_GET['delete'])) {
    ...
    if ($delete_query) {
        header('location:./halaman_upload_pdf.php');
    } else {
        header('location:./halaman_upload_pdf.php');
    };
};
...
<head>
    ...
    <title>Halaman Upload PDF</title>
    ...
    <div class="container">
        ...
        <section style="margin-top: 5px;">
            ...
            <form action="" method="post" class="add-product-form" enctype="multipart/form-data">
                <h3>Tambahkan PDF</h3>
                <input type="text" name="p_penulis" placeholder="masukkan penulis PDF" class="box" required>
                <input type="text" name="p_judul" min="0" placeholder="masukkan judul PDF" class="box" required>
                <input type="text" name="p_tanggal" min="0" onfocus="(this.type='date')" placeholder="masukkan tanggal"
                    class="box" required>
                <input type="file" name="p_pdf" accept="application/pdf" class="box" required>
                <input type="submit" value="Tambahkan PDF" name="add_product" class="btn">
            </form>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="./halaman_upload_pdf.php?delete=<?php echo $row['id']; ?>" class="delete-btn"
                                onclick="return confirm(' Yakin ingin dihapus?');"> <i class="fas fa-trash"></i> Hapus
                            </a>
                            <a href="./halaman_upload_pdf.php?edit=<?php echo $row['id']; ?>" class="option-btn"> <i
                                    class="fas fa-edit"></i> Perbarui </a>
                            <a href="./halaman_upload_pdf.php?view=<?php echo $row['id']; ?>" target="_blank"
