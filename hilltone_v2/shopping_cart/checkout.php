...
<section class="checkout-form">
   ...
   <div class="display-order">
      ...
      ?>
      <span class="grand-total"> grand total : <?= $grand_total; ?> IDR</span>
   </div>
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>Nomor HP</span>
            <input type="number" placeholder="masukkan nomor HP" name="number" required>
         </div>
         <div class="inputBox">
            <span>Email</span>
         ...
         <div class="inputBox">
            <span>Alamat 1</span>
            <input type="text" placeholder="e.g. apartemen CIT" name="flat" required>
         </div>
         <div class="inputBox">
            <span>Alamat 2</span>
            <input type="text" placeholder="e.g. jalan GRII" name="street" required>
         </div>
         <div class="inputBox">
            <span>Kota</span>
            <input type="text" placeholder="e.g. DKI Jakarta" name="city" required>
         </div>
         <div class="inputBox">
            <span>State</span>
            <input type="text" placeholder="e.g. DKI Jakarta" name="state" required>
         </div>
         <div class="inputBox">
            <span>Negara</span>
         ...
         <div class="inputBox">
            <span>Kode Pos</span>
            <input type="text" placeholder="e.g. 10610" name="pin_code" required>
         </div>
      </div>
      <input type="submit" value="Bayar" name="order_btn" class="btn">
   </form>
